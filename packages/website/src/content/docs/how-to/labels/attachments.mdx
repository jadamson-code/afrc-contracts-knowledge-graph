...
Unfortunately, even with the HTML+CSS renderer is probably the easier to use for developers, it uses SVG with `<foreignObject>` under the hood, which is blocked by Chromium and Safari at the moment.
:::
