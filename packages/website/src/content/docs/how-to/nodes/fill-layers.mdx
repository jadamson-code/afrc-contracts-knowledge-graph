...
<SigmaExample id="styling/node-borders" height="500px" showSource />
...
<SigmaExample id="styling/node-images" height="500px" showSource />
...
<SigmaExample id="styling/node-piecharts" height="500px" showSource />

## Composing layers

Layers compose naturally. The example below combines a fill, a border, and an image layer — composited in declaration order:

<SigmaExample id="styling/node-layers-composed" height="500px" showSource />
