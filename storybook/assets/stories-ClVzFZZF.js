import{G as h,S as p,w as g}from"./sigma-BdB3I2ax.js";import{l as x}from"./index-iaaY7pki.js";import{i as C}from"./index-Dqwe1tyM.js";import{d as k}from"./data-Bz6iBPrE.js";import{b as y,c as b}from"./index-BTBguz_L.js";import{b as E}from"./index-DbWjd5kp.js";import"./_commonjsHelpers-C4iS2aBk.js";import"./defaults-BeBqgnWC.js";import"./infer-type-DoRkJyXf.js";import"./getters-CXJ0gpj8.js";import"./is-graph-constructor-BVugt_gr.js";import"./add-edge-DJG1E9TZ.js";const w=()=>{const e=new h;e.import(k),x.assign(e,{nodeCommunityAttribute:"community"});const r=new Set;e.forEachNode((n,o)=>r.add(o.community));const t=Array.from(r),l=C(r.size).reduce((n,o,c)=>({...n,[t[c]]:o}),{});e.forEachNode((n,o)=>e.setNodeAttribute(n,"color",l[o.community]));const u=document.getElementById("sigma-container"),s=new p(e,u),a=document.createElement("div");return a.style.position="absolute",a.style.right="10px",a.style.bottom="10px",document.body.append(a),t.forEach((n,o)=>{const c=`cb-${n}`,i=document.createElement("div");i.innerHTML+=`
